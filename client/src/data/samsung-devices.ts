...
export const SAMSUNG_SERIES: SamsungSeries[] = [
  {
    ...
    models: [
      { name: "Samsung Galaxy A56 5G", slug: slug("Samsung Galaxy A56 5G"), screen: "6.7″ AMOLED 120Hz",          tag: "NEW", screenPrice: 135, screenPriceOEM: 95,  batteryPrice: 65, portPrice: 55 },
      ...
      { name: "Samsung Galaxy A36 5G", slug: slug("Samsung Galaxy A36 5G"), screen: "6.7″ AMOLED 120Hz",          tag: "NEW", screenPrice: 110, screenPriceOEM: 75,  batteryPrice: 58, portPrice: 50 },
      { name: "Samsung Galaxy A35 5G", slug: slug("Samsung Galaxy A35 5G"), screen: "6.6″ Super AMOLED 120Hz",           screenPrice: 100, screenPriceOEM: 68,  batteryPrice: 55, portPrice: 50 },
      { name: "Samsung Galaxy A26 5G", slug: slug("Samsung Galaxy A26 5G"), screen: "6.7″ AMOLED 120Hz",          tag: "NEW", screenPrice: 85,  screenPriceOEM: 58,  batteryPrice: 52, portPrice: 45 },
