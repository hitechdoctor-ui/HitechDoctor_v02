...
export const LAPTOP_BRANDS: LaptopBrand[] = [
  {
    ...
    tag: "Premium",
    screenPriceFrom: 350,
    batteryPriceFrom: 150,
    keyboardPriceFrom: 250,
    thermalPrice: 60,
    portPriceFrom: 90,
    upgradeLabor: 0,
    notes: "Τα MacBook με Apple Silicon (M1/M2/M3/M4) δεν αναβαθμίζονται σε RAM/SSD. Η αλλαγή πληκτρολογίου απαιτεί αντικατάσταση top-case.",
    color: "#9ca3af",
