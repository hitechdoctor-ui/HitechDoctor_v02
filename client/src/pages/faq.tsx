...
const FAQS = [
  ...
  { q: "Πώς κλείνω ραντεβού;", a: "Μπορείτε να μας καλέσετε στο 698 188 2005, να μας στείλετε μήνυμα στο WhatsApp, ή να συμπληρώσετε τη φόρμα επικοινωνίας. Εξυπηρετούμε και walk-in χωρίς ραντεβού." },
