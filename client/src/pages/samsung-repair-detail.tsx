...
export default function SamsungRepairDetail() {
  ...
  const pageDesc = `Επισκευή ${model.name} στην Αθήνα. Αλλαγή οθόνης €${model.screenPrice}, μπαταρία €${model.batteryPrice}, θύρα USB-C €${model.portPrice}. Γνήσια ανταλλακτικά, εγγύηση, αποτέλεσμα 30 λεπτά.`;
        ...
        <div className="flex flex-wrap items-start gap-4 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-2 flex-wrap">
              ...
              {model.foldable && (
                <span className="text-[10px] font-bold px-2 py-0.5 rounded border border-amber-500/30 bg-amber-500/10 text-amber-400">
                  Foldable
                </span>
              )}
            </div>
        ...
        <div className="lg:grid lg:grid-cols-3 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section id="section-screen">
              ...
              <div className="prose prose-sm prose-invert max-w-none text-muted-foreground leading-relaxed">
                ...
                <p>
                  ...
                  λειτουργικότητα αισθητήρων, touch και έντασης χρωμάτων. Η εγκατάσταση πραγματοποιείται
                  σε καθαρό εργαστήριο και συνοδεύεται από γραπτή εγγύηση.
                </p>
            ...
            <section id="section-battery">
              ...
              <h2 className="text-xl font-display font-bold text-foreground mb-3">
                Αλλαγή Μπαταρίας {model.name}
              </h2>
              <div className="prose prose-sm prose-invert max-w-none text-muted-foreground leading-relaxed">
                <p>
                  Αν το {model.name} σας δεν κρατάει εφόσον μισή μέρα, κλείνει ξαφνικά ή η μπαταρία
                  έχει φουσκώσει, ήρθε η ώρα αντικατάστασης. Η διαδικασία ολοκληρώνεται σε 30–60 λεπτά.
                </p>
                <p>
                  Χρησιμοποιούμε κύτταρα που πληρούν τα πρότυπα Samsung: σταθερή χωρητικότητα,
                  ασφαλή φόρτιση και πιστοποίηση CE. Μετά την αντικατάσταση θα έχετε ξανά 100% αυτονομία.
                </p>
                <ul className="list-none space-y-1.5 mt-3">
                  {[
                    "Δωρεάν μέτρηση υγείας μπαταρίας πριν την επισκευή",
                    "Αντικατάσταση με premium ή γνήσιο κύτταρο μπαταρίας",
                    "Βαθμονόμηση & δοκιμή κύκλων φόρτισης",
                    "Γραπτή εγγύηση 12 μηνών",
                  ].map((item) => (
                    <li key={item} className="flex items-center gap-2 text-xs">
                      <CheckCircle2 className="w-3.5 h-3.5 text-primary shrink-0" />
                      {item}
            ...
            <section id="section-port">
              ...
              <h2 className="text-xl font-display font-bold text-foreground mb-3">
                Επισκευή Θύρας USB-C {model.name}
              </h2>
              <div className="prose prose-sm prose-invert max-w-none text-muted-foreground leading-relaxed">
                <p>
                  Προβλήματα φόρτισης στο {model.name} συνήθως οφείλονται σε συσσώρευση σκόνης ή
                  κατεστραμμένες ακίδες στη θύρα USB-C. Πριν προχωρήσουμε σε αντικατάσταση,
                  πραγματοποιούμε δωρεάν καθαρισμό και διάγνωση.
                </p>
                <ul className="list-none space-y-1.5 mt-3">
                  {[
                    "Δωρεάν καθαρισμός & διάγνωση θύρας",
                    "Αντικατάσταση module USB-C αν απαιτείται",
                    "Δοκιμή φόρτισης & μεταφοράς δεδομένων",
                ...
                {[
                  {
                    ...
                    a: `Η αλλαγή οθόνης ${model.name} κοστίζει €${model.screenPrice} με ΦΠΑ. Η τιμή περιλαμβάνει ανταλλακτικό και εργασία.`,
                  },
                  {
                  ...
                  {
                    q: "Δίνετε εγγύηση;",
                    a: "Ναι, κάθε επισκευή καλύπτεται από γραπτή εγγύηση 12 μηνών για ανταλλακτικό και εργασία.",
                  },
                  {
                  ...
                  <details
                    key={q}
                    className="group bg-card pcb-border rounded-xl p-4 cursor-pointer"
                    data-testid={`faq-${q.substring(0, 20).replace(/\s+/g, "-").toLowerCase()}`}
                  >
