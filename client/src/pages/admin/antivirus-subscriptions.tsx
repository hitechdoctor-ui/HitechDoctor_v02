      ...
      <div className="space-y-6">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 text-muted-foreground">
            ...
            <p>Δεν υπάρχουν συνδρομές antivirus ακόμα.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/8 bg-white/3">
                  {["Πελάτης", "Email / Τηλ.", "Έναρξη", "Λήξη", "Κατάσταση", ""].map(h => (
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <FormField control={form.control} name="email" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input {...field} type="email" data-testid="input-sub-email" /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
              ...
              <FormField control={form.control} name="notes" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Textarea {...field} rows={2} className="resize-none" data-testid="textarea-sub-notes" /></FormControl>
                </FormItem>
              )} />
