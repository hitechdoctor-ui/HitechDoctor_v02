        ...
        >
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-[10px] text-slate-600 truncate">{entry.sub}</p>
                          </div>
                          <ArrowRight className="w-3.5 h-3.5 text-slate-400 group-hover:text-primary transition-colors shrink-0" />
                        </button>
                      );
          ...
          <div className="px-3 py-2 border-t border-slate-200 flex items-center gap-4 bg-slate-50/95 sticky bottom-0">
            <span className="text-[9px] text-slate-500 flex items-center gap-1">
              <kbd className="px-1 rounded border border-slate-200 bg-white font-mono text-slate-700">↵</kbd> Μετάβαση
            </span>
            <span className="text-[9px] text-slate-500 flex items-center gap-1">
              <kbd className="px-1 rounded border border-slate-200 bg-white font-mono text-slate-700">Esc</kbd> Κλείσιμο
            </span>
          </div>
        </div>
      )}
